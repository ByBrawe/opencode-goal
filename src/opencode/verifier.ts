  ...
  function configure(config: any) {
    ...
    config.agent[agentName] = {
      ...
      tools: {
        ...
        apply_patch: false,
        task: false,
        opencode_goal_get: false,
        opencode_goal_progress: false,
        opencode_goal_evidence_file: false,
        opencode_goal_complete: false,
        opencode_goal_blocked: false,
        opencode_goal_verifier_result: true,
      },
    }
  }
