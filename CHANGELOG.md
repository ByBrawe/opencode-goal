...
- Add a current OpenCode 2.0.16 real-host gate that proves a three-unit Goal crosses exactly three native sessions and completes with host + independent semantic verifier evidence.
