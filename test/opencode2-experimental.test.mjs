...
async function runRequest(host, {
  ...
  const hook = host.hooks.get("request") ?? host.hooks.get("context")
...
test("experimental V2 plugin registers an isolated command, direct tools, and current request hook", async () => {
